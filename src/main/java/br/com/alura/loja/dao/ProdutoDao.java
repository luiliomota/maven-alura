...
public class ProdutoDao {
	...
	public List<Produto> buscarPorParametrosComCriteria (String nome, BigDecimal preco, LocalDate dataCadastro){
		...
		if(nome != null && !nome.trim().isEmpty())
			filtros = builder.and(filtros, builder.and(builder.equal(from.get("nome"), nome)));
		if(preco != null)
			filtros = builder.and(filtros, builder.and(builder.equal(from.get("preco"), preco)));
		if(dataCadastro != null)
			filtros = builder.and(filtros, builder.and(builder.equal(from.get("dataCadastro"), dataCadastro)));
